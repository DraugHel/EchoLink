      ...
      parameters: {
        ...
        properties: {
          ...
          retentionDays: {
            ...
            description:
              'Optional number of days to keep messages generated by this task. Omit for unlimited retention.'
          }
        },
        required: [
          'title',
      ...
      parameters: {
        ...
        properties: {
          ...
          retentionDays: {
            ...
            maximum: MAX_RETENTION_DAYS,
            description:
              'Optional number of days to keep messages generated by this task.'
          }
        },
        required: ['taskId']
      }
...
function readRetentionDays(value, fallback = null) {
  ...
  if (
    ...
    throw new Error(
      `retentionDays muss zwischen 1 und ${MAX_RETENTION_DAYS} liegen`
    )
  }
